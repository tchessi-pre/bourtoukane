...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 flex items-center gap-2 bg-[#086d2d] text-white px-4 py-3 rounded-full shadow-lg hover:bg-[#0e8339] transition-all hover:scale-105"
